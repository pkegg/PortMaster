...
cd $toolsfolderloc
SDL_GAMECONTROLLERCONFIG_FILE="$toolsfolderloc/PortMaster/gamecontrollerdb.txt" $ESUDO $toolsfolderloc/PortMaster/gptokeyb $ESUDOKILL "PortMaster.sh" -c "$toolsfolderloc/PortMaster/PortMaster.gptk" > /dev/null 2>&1 &
